...
public class PushMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData().size() > 0) {
            ...
            sendBroadcastMessage("Push",remoteMessage.getData().get("body"),remoteMessage.getData().get("url"));
    ...
    public void sendBroadcastMessage(String key,String message, String url){
        try{
            Intent intentToBeSent=new Intent();
            intentToBeSent.putExtra(key,message);
            intentToBeSent.putExtra("url",url);
